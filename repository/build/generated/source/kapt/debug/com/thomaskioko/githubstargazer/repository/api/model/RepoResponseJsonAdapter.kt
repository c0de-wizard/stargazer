  ...
  override fun fromJson(reader: JsonReader): RepoResponse {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        3 -> owner = userResponseAdapter.fromJson(reader) ?: throw Util.unexpectedNull("owner",
            "owner", reader)
        4 -> stargazersCount = intAdapter.fromJson(reader) ?:
            throw Util.unexpectedNull("stargazersCount", "stargazers_count", reader)
        5 -> forksCount = intAdapter.fromJson(reader) ?: throw Util.unexpectedNull("forksCount",
            "forks", reader)
        6 -> contributorsUrl = stringAdapter.fromJson(reader) ?:
            throw Util.unexpectedNull("contributorsUrl", "contributors_url", reader)
        7 -> createdDate = stringAdapter.fromJson(reader) ?:
            throw Util.unexpectedNull("createdDate", "created_at", reader)
        8 -> updatedDate = stringAdapter.fromJson(reader) ?:
    ...
    return RepoResponse(
        ...
        contributorsUrl = contributorsUrl ?: throw Util.missingProperty("contributorsUrl",
            "contributors_url", reader),
        createdDate = createdDate ?: throw Util.missingProperty("createdDate", "created_at",
            reader),
