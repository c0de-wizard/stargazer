...
class StargazerPreferencesImpl @Inject constructor(
    @ApplicationContext private val context: Context,
    @Named("app") private val sharedPreferences: SharedPreferences
) : StargazerPreferences {
    ...
    override fun observeTheme(): Flow<Theme> {
        return preferenceKeyChangedFlow
            ...
            .filter { it == KEY_THEME }
            .map { getThemeForStorageValue(sharedPreferences.getString(KEY_THEME, defaultThemeValue)!!) }
