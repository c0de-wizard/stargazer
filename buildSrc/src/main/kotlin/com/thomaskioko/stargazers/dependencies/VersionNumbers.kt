...
object PluginsVersions {
    ...
    const val daggerHiltAndroid: String = "2.35"
...
object DependencyVersions {
    ...
    const val accompanistGoogle = "0.8.1"
    ...
    const val coreKtx = "1.6.0-alpha02"
    const val dataStore = "1.0.0-beta01"
    const val espresso: String = "3.4.0-alpha05"
    const val fragmentTesting: String = "1.3.3"
    const val hilt = "2.35"
